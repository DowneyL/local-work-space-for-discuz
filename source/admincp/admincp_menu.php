...
$menu['forum'] = array(
	...
	//版主申请创建接口,然后建立admincp_koueiapply.php文件，建立后台数据页面。
	array('kouei_add_action','koueiapply'),
	array('kouei_apply_log','koueiapplylog'),
	//人才供求版块功能
	array('menu_forums_kouei_recruit','koueirec_search'),
	array('menu_forums_kouei_jobhunt','koueijob_search'),
	//附加后台功能添加区域
