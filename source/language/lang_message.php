...
$lang = array (
  ...
  //版主申请提示
  'kouei_apply_success' => '申请提交成功，请等待管理员的审核或者联系！',
  'kouei_apply_failed' => '申请提交失败，请重新填写申请表格，不便之处请谅解！',
  'kouei_apply_refuse' => '抱歉，您没有权限访问该版块！',
  'kouei_apply_error' => '抱歉，我们已经收到过您的申请，请耐心等待！',


  'kouei_talents_license_type_size' => '抱歉，您未上传营业执照，或文件尺寸过大，类型有误。',
  'kouei_talents_form_check' => '表单未填写完全或填写有误，请重新填写！',
  'kouei_talents_error' => '抱歉，您无权使用该功能！',

  'kouei_validate_mobile_register' => '为推广实名注册，请先绑定您的手机号，再进行下一步操作！',
  'kouei_validate_mobile_register_extra' => '为推广实名注册，请先绑定您的手机号，再进行下一步操作！（网页顶部 -> 手机绑定）'
);
