...
$lang = array (
  ...
  'kouei_no_find_delrec' => '抱歉，没有搜索到需要删除的数据',
  'koueirec_delete_confirm' => '本操作会将数据对应的帖子也放入回收站中，您确定要删除符合条件的 {reccount} 条数据吗？',
  'koueijob_delete_confirm' => '本操作会将数据对应的帖子也放入回收站中，您确定要删除符合条件的 {jobcount} 条数据吗？',
  'kouei_result_attention' => '成功处理 {sucnum} 条数据，失败 {delnum} 条',
  'kouei_output_fail' => '导出失败，请确定您正确输入了搜索时间！',
  'kouei_set_mobile_validate_success' => '成功，该设置下用户不用验证手机号码',
  'kouei_set_mobile_validate_error' => '设置失败，请稍后重试',
);
